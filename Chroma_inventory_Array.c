...
int main() {
    int Product_ID[]={1245,5483,6596,4966,2605,5449,3699,5618,9999,3346};
    int Product_Quantity[]={2,5,9,4,6,9,2,4,5,6};
    

    char Product_Name[][20]={"Laptop","Mobile","Tablet","SmartTV","Watch","Camera","Earbuds","Speaker","Monitor","Router"};
    
    float Product_MRP[]={95000.0,32000.0,38000.0,55000.0,5000.0,750000.0,25000.0,9000.0,19000.0,1500.0};
    
    float Discount[]={23.0,5.0,8.0,15.0,2.0,29.0,5.0,13.0,6.0,0.0}; 
