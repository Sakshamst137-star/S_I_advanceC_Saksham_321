...
int main() {
    ...
    struct Product inventory[10] = {
        {1245, "Laptop",  2, 95000.0,  23.0},
        {5483, "Mobile",  5, 32000.0,   5.0},
        {6586, "Tablet",  9, 38000.0,   8.0},
        {4966, "SmartTV", 4, 55000.0,  15.0},
        {2605, "Watch",   6,  5000.0,   2.0},
        {5449, "Camera",  9, 750000.0, 29.0},
        {3699, "Earbuds", 2, 25000.0,   5.0},
        {5618, "Speaker", 4,  9000.0,   13.0}.
        {9999, "Monitor", 5, 19000.0,  6.0},
        {3346, "Router",  6,  1500.0,   0.0}
    };
